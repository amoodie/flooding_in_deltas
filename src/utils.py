...
class MinMaxSlider(AxesWidget):
    ...
    def __init__(self, ax, label, valmin, valmax, valinit=0.5, valfmt='%1.2f',
        ...
        self.mintext = ax.text(-0.02, 0.5, format_number(valmin),
                               transform=ax.transAxes,
                               verticalalignment='center',
                               horizontalalignment='right')
        self.maxtext = ax.text(1.02, 0.5, format_number(valmax),
                               transform=ax.transAxes,
                               verticalalignment='center',
                               horizontalalignment='left')
        self.valtext = ax.text(0.5, 0.45, format_number(valinit),
                               transform=ax.transAxes,
                               verticalalignment='center',
                               horizontalalignment='center',
                               weight='bold')
    ...
    def set_val(self, val):
        ...
        xy[3] = val, 0
        self.poly.xy = xy
        self.valtext.set_text(format_number(val))
        if self.drawon:
